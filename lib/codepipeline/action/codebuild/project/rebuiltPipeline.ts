            ...
            buildSpec: codebuild.BuildSpec.fromObject({
                ...
                phases: {
                    ...
                    build: {
                        commands: [
                            'npm run build',
                            `npm run cdk synth AwsCdkPipelineCelebritiesStack -- -c envName=${props.envName} branchName=${props.branchName} repo=${props.repo} repoOwner=${props.repoOwner} repoSecretName=${props.repoSecretName}`,
